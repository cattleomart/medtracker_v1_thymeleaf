...
INSERT INTO PRESCRIPTION (ID, MEDICATION_ID, PATIENT_ID, PRACTITIONER_ID, BEGIN_TIME, END_TIME, DOSE_MG)
SELECT '1', '1','3', '2', {ts '2022-04-22 10:34:53.44'}, {ts '2022-04-22 10:34:53.44'}, '15'
WHERE
NOT EXISTS (
