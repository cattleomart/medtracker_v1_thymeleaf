...
INSERT INTO PRESCRIPTION (ID, DRUG, PATIENT_ID, PRACTITIONER_ID, BEGIN_TIME, END_TIME)
SELECT '1','FOO', '3', '2', {ts '2022-04-22 10:34:53.44'}, {ts '2022-04-22 10:34:53.44'}
WHERE
NOT EXISTS (
    SELECT PATIENT_ID FROM PRESCRIPTION WHERE PATIENT_ID = '3'
);

INSERT INTO PRESCRIPTIONSCHEDULEENTRY (DAYSTAGE, PRESCRIPTION_ID)
SELECT 'BREAKFAST', '1'
WHERE
NOT EXISTS (
    SELECT PRESCRIPTION_ID FROM PRESCRIPTIONSCHEDULEENTRY WHERE PRESCRIPTION_ID = '1' AND DAYSTAGE = 'BREAKFAST'
);
INSERT INTO PRESCRIPTIONSCHEDULEENTRY (DAYSTAGE, PRESCRIPTION_ID)
SELECT 'LUNCH', '1'
WHERE
NOT EXISTS (
    SELECT PRESCRIPTION_ID FROM PRESCRIPTIONSCHEDULEENTRY WHERE PRESCRIPTION_ID = '1' AND DAYSTAGE = 'LUNCH'
);
