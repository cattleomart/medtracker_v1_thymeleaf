...
INSERT INTO PRESCRIPTION (ID, DRUG, MEDICATION_ID, PATIENT_ID, PRACTITIONER_ID, BEGIN_TIME, END_TIME, DOSE_MG)
SELECT '1','FOO', '1','3', '2', {ts '2022-04-22 10:34:53.44'}, {ts '2022-04-22 10:34:53.44'}, '15'
WHERE
NOT EXISTS (
...
INSERT INTO DOSE (ID, DOSE_TIME, TAKEN, dailyevaluation_record_Date,dailyevaluation_userModel_id,prescription_schedule_entry_id)
SELECT '1', {ts '2022-04-22 10:34:53.44'},'TRUE', {ts '2024-04-22'},'1','1'
WHERE
NOT EXISTS (
